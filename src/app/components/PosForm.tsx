      ...
      <Row gutter={[16, 16]}>
          ...
          <Card title="Transaction Details">
            <Row>
              <Col span={8} style={{ padding: 5 }}>
                <Form.Item label={particularsTitle[0]} rules={[{required:true}]}>
                    <Input
                      disabled
                      maxLength={50}
                      value={cname}
        ...
        <Col xs={24} sm={24} md={6} lg={6} xl={6}>
              ...
              <Card title="Summary" style={{ marginTop: 16 }}>
                SUB TOTAL TRADE POS:
                <div style={{ marginBottom: 10 }}> ₱ <Text strong>{parseFloat(subTotalTradePOS.toString()).toLocaleString()}</Text> </div>
                GRAND TOTAL POS:
                <div style={{ marginTop: 10 }}> ₱ <Text strong>{parseFloat(grandTotalPOS.toString()).toLocaleString()}</Text> </div>
              </Card>
        </Col>
      </Row>
    </Form>
