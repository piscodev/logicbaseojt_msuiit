...
export async function GET()
{
  ...
  try {
    ...
    return NextResponse.json({ date: new Date(), data: [{t1: tradeRows.slice(-1).pop(), t2: (subTotalNonTradeAM + subTotalNonTradeMID + subTotalNonTradePM), t3: nonTradeRows.slice(-1).pop()}] }, { status: 200 });
